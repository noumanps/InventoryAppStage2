...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryappstage2/products" will map to the
        ...
        // For example, "content://com.example.android.inventoryappstage2/products/3" matches, but
        // "content://com.example.android.inventoryappstage2/products" (without a number at the end) doesn't match.
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (image == null) {
            throw new IllegalArgumentException("Product Image required");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ProductEntry#COLUMN_PRODUCT_SUPPLIER_CONTACT} key is present,
        // check that the name value is not null.
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_SUPPLIER_CONTACT)) {
            String supplierContact = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER_CONTACT);
            if (supplierContact == null) {
                throw new IllegalArgumentException("Product requires the Supplier's Contact");
            }
        }
